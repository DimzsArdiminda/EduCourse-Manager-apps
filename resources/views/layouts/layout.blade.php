...
<head>
    ...
    {{-- icon --}}
    <link rel="icon" type="image/x-icon" href="assets/img/homepage/logo.png">
    ...
    <title>SiPRO - Inovasi Media Pembelajaran Digital pada Materi Kombinatorika</title>
</head>

<body class="font-sans antialiased ">

    <div class="min-h-screen"
        style="background-image: url('{{ asset('assets/img/layout-background.png') }}'); background-size: cover; background-position: center;">
        <div class="p-4">
            @yield('content')
        </div>
    </div>
